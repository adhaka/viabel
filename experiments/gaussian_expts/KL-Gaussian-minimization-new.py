...
if divergence == 1:
    ...
    results = dict()
    results['name'] = cov_structure+'-exclusive_kl_gaussian_mf_vi'
    ...
    sns.despine()
    plt.savefig(f'../../writing/variational-objectives/figures_new/{cov_structure}-kl-vb-d1.pdf', bbox_inches='tight')
    plt.clf()
#plt.show()
    ...
    plt.legend(rhos, loc='upper center', bbox_to_anchor=(0.5, 1.4),
               ncol=3, frameon=False)
    sns.despine()
    plt.savefig(f'../../writing/variational-objectives/figures_new/{cov_structure}-inckl-vb-d1.pdf', bbox_inches='tight')
    plt.clf()
    #plt.show()
    ...
    plt.legend(rhos, loc='upper center', bbox_to_anchor=(0.5, 1.4),
               ncol=3, frameon=False)
    sns.despine()
    plt.savefig(f'../../writing/variational-objectives/figures_new/{cov_structure}-gaussian_mean_field_paretok1.pdf', bbox_inches='tight')
    plt.clf()
#plt.show()
    ...
    plt.legend(rhos, loc='upper center', bbox_to_anchor=(0.5, 1.4),
               ncol=3, frameon=False)
    sns.despine()
    plt.savefig(f'../../writing/variational-objectives/figures_new/{cov_structure}-kl-gaussian_mean_field_paretok2.pdf', bbox_inches='tight')
    plt.clf()
...
if divergence == 3:
    ...
    for rho in rhos:
        for d in ds:
            ...
            opt_param, var_param_history, val ,_=  adagrad_optimize(3800, div_objective_and_grad, init_var_param, learning_rate=0.006)
